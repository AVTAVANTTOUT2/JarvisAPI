        ...
        if context:
            ...
            if context.get("voice_mode"):
                base += (
                    ...
                    "Réponds directement, sans préambule ni formule creuse.\n"
                    "Ne salue pas l'utilisateur au milieu d'une session.\n"
                    "N'ajoute pas « Monsieur » aux réponses ordinaires : cet honorifique est "
                    "réservé à une véritable ouverture ou fermeture de session, ou à un rituel "
                    "explicitement prévu.\n"
                    ...
                    "- Ne prétends jamais qu'une source est accessible si son statut est "
                    "degraded/unavailable ; dis précisément que la vérification est indisponible.\n"
