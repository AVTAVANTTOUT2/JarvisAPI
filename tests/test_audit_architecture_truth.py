...
def test_real_repo_smoke_counts_stable() -> None:
    ...
    # Vague 2B + chat : location_point_dedup + mobile_chat_dedup
    assert tables["counts"]["persistantes_post_init"] == 72
    assert tables["counts"]["physiques_max_default_fts_on"] == 77
