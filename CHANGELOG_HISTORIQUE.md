# Historique JARVIS — changelogs et notes de setup (archive)

> Ancien README.md, conservé tel quel. Il accumule les changelogs détaillés de
> chaque évolution du projet et les notes de setup historiques. Le README
> actuel, aligné sur la codebase, est à la racine : [README.md](./README.md).
