...
- **[`RAPPORT_PIRE_AUDIT.md`](./RAPPORT_PIRE_AUDIT.md)** — consolidation des sorties des agents Cursor d’audit ligne par ligne (P01–P14), findings classés du plus grave au moindre, annexe avec rapports bruts concaténés pour traitement Claude Opus.
...
| Périmètres | État |
|---|---|
| P01–P14 | Sorties récupérées et archivées |
| P15–P18 (mobile, Android, TV, tests/CI) | Absents — aucun agent Cursor trouvé |
