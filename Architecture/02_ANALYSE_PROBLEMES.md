...
- **Correction** : routeurs FastAPI par domaine (ADR-008). Le contrat courant est verrouillé à 267 opérations HTTP, 2 WebSockets et 237 chemins OpenAPI par les tests et l'inventaire généré.
