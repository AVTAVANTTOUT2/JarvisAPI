...
- **Correction** : routeurs FastAPI par domaine (ADR-008). Le contrat courant est verrouillé à 269 opérations HTTP, 2 WebSockets et 239 chemins OpenAPI par les tests et l'inventaire généré.
