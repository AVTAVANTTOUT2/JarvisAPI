...
**Périmètre** : 213 fichiers Python (53 167 lignes), 70 fichiers frontend, 72 tables SQLite après migrations
...
│                     JARVIS API                           │
├─────────────────────────────────────────────────────────┤
│  Backend           │ 213 fichiers Python, 53 167 lignes  │
...
│  Tests             │ 532 fonctions de test, 59 fichiers  │
├─────────────────────────────────────────────────────────┤
│  God objects       │ main.py (7 194 lignes, 40+ resp.)   │
│                    │ database/__init__.py (3 530 lignes)  │
