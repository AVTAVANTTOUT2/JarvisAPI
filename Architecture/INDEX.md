...
**Périmètre** : 195 fichiers Python (52 552 lignes), 70 fichiers frontend (15 643 lignes), 44 tables SQLite
...
│  Base de données   │ 44 tables SQLite, mode WAL          │
...
graph TB
    ...
    subgraph "Database"
        DB[(SQLite WAL<br/>jarvis.db<br/>44 tables)]
