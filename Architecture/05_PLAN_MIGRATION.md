...
**État** : ✅ Implémentée et validée le 14/07/2026, puis étendue. Le contrat courant compte 267 opérations HTTP, 2 WebSockets et 237 chemins OpenAPI ; `main.py` reste un assemblage sous 500 lignes.
