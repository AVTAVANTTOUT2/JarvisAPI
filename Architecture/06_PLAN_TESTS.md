...
**Couverture actuelle** : 531 fonctions de test déclarées dans 59 fichiers (backend uniquement). La collecte complète doit être exécutée avec la version Python supportée par le projet.
...
|---|---|---|---|---|
| Unitaires backend | pytest | Fonctions pures, classes | 531 fonctions déclarées | Maintenir et mesurer la couverture |
...
| Fonctions de test backend déclarées | 531 | ≥531 | ≥531 |
