...
**Couverture actuelle** : 523 fonctions de test déclarées dans 55 fichiers (backend uniquement). La collecte complète doit être exécutée avec la version Python supportée par le projet.
...
|---|---|---|---|---|
| Unitaires backend | pytest | Fonctions pures, classes | 523 fonctions déclarées | Maintenir et mesurer la couverture |
...
| Fonctions de test backend déclarées | 523 | ≥523 | ≥523 |
