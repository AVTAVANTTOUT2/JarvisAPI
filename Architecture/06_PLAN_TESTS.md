...
Preuves courantes : signatures de 261 opérations HTTP et 2 WebSockets inventoriées ; hash des 232 chemins OpenAPI ; 17 routeurs `api/router_*.py` plus Fitness ; `main.py` sous 500 lignes ; aucun import `api → main`. Les suites CI actuelles remplacent les totaux pytest historiques. Aucune validation opérationnelle 24 h n'est revendiquée.
