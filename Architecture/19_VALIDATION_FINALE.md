...
- **Couplage (4/10)** : 1 dépendance circulaire, 42 imports dans main.py, 25+ connexions directes à chat.db. Event bus inutilisé.
- **Cohésion (5/10)** : Les agents sont bien séparés, les intégrations aussi. Mais la database et main.py sont des fourre-tout.
- **Testabilité (4/10)** : 174 tests backend, mais 0 test frontend, pas de tests par route, pas de tests d'intégration iMessage.
