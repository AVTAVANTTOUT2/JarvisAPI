...
- **Testabilité (4/10)** : 523 fonctions de test backend déclarées dans 55 fichiers, mais 0 test frontend, pas de couverture fiable par route et pas de tests d'intégration iMessage complets.
